...
pub struct InstanceAuthorization {
    ...
    pub tts_config_source: Option<String>,
...
pub struct EntitlementGrant {
    ...
    pub tts_backend_id: String,
    pub tts_config_source: String,
...
impl AuthorityService {
    ...
    async fn apply_grant(&self, grant: EntitlementGrant) {
        ...
        *snapshot = InstanceAuthorization {
            ...
            tts_backend_id: Some(grant.tts_backend_id),
            tts_config_source: Some(grant.tts_config_source),
